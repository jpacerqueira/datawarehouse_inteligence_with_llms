...
from dw_intel.datamap_api.models.sql_in_context import SQLInContextResponse
...
@router.post("/sql_in_context", response_model=SQLInContextResponse, tags=["analysis"])
